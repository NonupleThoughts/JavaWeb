...
<%
	...
	studentDAO.findStudentCurriculum(student);
	ArrayList<StudentCurriculum> curriculum = studentDAO.findStudentCurriculum(student);
	...
	{
		//结合lambda表达式进行拍寻
		Collections.sort(allDay.get(i), (StudentCurriculum a, StudentCurriculum b)->{return a.getStart() - b.getStart();});
		/*
